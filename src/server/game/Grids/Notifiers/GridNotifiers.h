...
namespace Acore
{
    ...
    public:
        ...
        bool operator()(Unit* u)
        {
            ...
            if (!u->IsInMap(i_obj) || !u->IsWithinDoubleVerticalCylinder(i_obj, searchRadius, searchRadius))
                return false;
    ...
    public:
        ...
        bool operator()(Unit* u)
        {
            ...
            return u->IsInMap(_source) && u->IsWithinDoubleVerticalCylinder(_source, searchRadius, searchRadius);
        }
    ...
    public:
        ...
        bool operator()(Unit* u)
        {
            ...
            return u->IsInMap(i_obj) && u->IsWithinDoubleVerticalCylinder(i_obj, searchRadius, searchRadius);
        }
    private:
